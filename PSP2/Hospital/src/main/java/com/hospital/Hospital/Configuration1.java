...
public class Configuration1 {
    ...
    @Bean
    PatientService patientService() { return new PatientServiceImp(); }

    @Bean
    PatientFactory patientFactory() { return new SimplePatientFactory(); }

    @Bean
    PatientRepository patientRepository() { return new PatientRepositoryImp(); }
